                        ...
                        <div class='col-md-4 col-xs-6'>
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='product-body'>
										<p class='product-category'>$cat_name</p>
										<h3 class='product-name header-cart-item-name'><a href='product.php?p=$pro_id'>$pro_title</a></h3>
										<h4 class='product-price header-cart-item-info'>$pro_id</h4>
									</div>
									<div class='add-to-cart'>
					...
					echo 
						...
						<td data-th="Product" >
							...
							<td data-th="Quantity">
								...
								<input type="text" class="form-control qty"  name="quantity_'.$x.'" value="'.$row["qty"].'">
							</td>
							<td data-th="Subtotal" class="text-center"> <input type="text" name="amount_'.$x.'" value="'.$row["product_price"].'" class="form-control total">  </td>
