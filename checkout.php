			...
			<div class="col-75">
				...
				<form id="checkout_form" action="checkout_process.php" method="POST" class="was-validated">
					...
					while($i<=$total_count){
						...
						echo "	
						<input type='hidden' name='prod_id_$i' value='product id $product_id'>
						<input type='hidden' name='prod_price_$i' value='amount $amount_'>
						<input type='hidden' name='prod_qty_$i' value='quantity $quantity_'>
						<input type='hidden' name='total_count' value='total is".$amount_ * $quantity_."'>
						";
						$i++;
					}
				...
				echo'	
					...
					<input type="hidden" id="checkout_amount" name="total_price" value="'.$total.'">
					
					<button type="submit" id="submit" name="checkout" class="checkout-btn">Continue to Checkout</button>
				</form>
				</div>
			</div>
			';
